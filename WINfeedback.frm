...
Public Sub SendFeedback()
    ...
    MyMail.Configuration.Fields(cdoSMTPServer) = "smtp.anico.in" '"ex7.anico.in" or "smtp.anico.in"
    ...
    MyMail.Configuration.Fields(cdoSendUserName) = "feedback@anico.in"
    MyMail.Configuration.Fields(cdoSendPassword) = "<AVAZ9C]r%Sp8=$lFww^>4MK"
    ...
    MyMail.From = """ANIco.in Feedback Management System"" <feedback@anico.in>"
